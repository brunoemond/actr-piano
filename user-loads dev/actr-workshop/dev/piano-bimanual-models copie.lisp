...
(defun model3 ()
  ...
  (define-model foo
    ...
    (define-chunks 
     ;; Hand-on-piano movement styles, just placing the hands on the piano.
     (place-lh-on-piano isa move-lh-with-thumb l-thumb c4 next place-rh-on-piano)
     (place-rh-on-piano isa move-rh-with-thumb r-thumb c4 next play-thumb)
     (play-thumb        isa press-hand-fingers r-thumb t  next stop)
     )
...
(defun model4 ()
  ...
  (define-model foo
    ...
    (define-chunks 
     ...
     (place-rh-on-piano  isa move-rh-with-thumb r-thumb c4     next roll-thumb-at-ring)
     (roll-thumb-at-ring isa move-rh-with-thumb r-thumb r-ring next stop)
     )
      
    (goal-focus place-rh-on-piano)
...
(defun model5 ()
  ...
  (define-model foo
    ...
    (define-chunks 
     ;; moving the thumb under the hand
     (place-rh-on-piano  isa move-rh-with-thumb   r-thumb c4     next press-thumb1)
     ...
     (press-index1       isa press-hand-fingers   r-index t      next release-index1)
     (release-index1     isa release-hand-fingers r-index t      next press-middle1)

     (press-middle1      isa press-hand-fingers   r-middle t     next release-middle1)
     (release-middle1    isa release-hand-fingers r-middle t     next roll-thumb-at-ring)

     (roll-thumb-at-ring isa move-rh-with-thumb   r-thumb r-ring next press-thumb2)

     (press-thumb2       isa press-hand-fingers   r-thumb t      next release-thumb2)
     (release-thumb2     isa release-hand-fingers r-thumb t      next press-index2)

     (press-index2       isa press-hand-fingers   r-index t      next release-index2)
     (release-index2     isa release-hand-fingers r-index t      next press-middle2)

     (press-middle2      isa press-hand-fingers   r-middle t     next release-middle2)
     (release-middle2    isa release-hand-fingers r-middle t     next press-ring1)

     (press-ring1        isa press-hand-fingers   r-ring t       next release-ring1)
     (release-ring1      isa release-hand-fingers r-ring t       next press-pinkie1)

     (press-pinkie1      isa press-hand-fingers   r-pinkie t     next release-pinkie1)
     (release-pinkie1    isa release-hand-fingers r-pinkie t     next stop)
     )
